...
class _LabelsPageState extends State<LabelsPage>
                    ...
                    child: RefreshIndicator(
                      ...
                      child: TabBarView(
                        ...
                        children: [
                          ...
                          if (user.canViewTags) _buildTagsView(state, user),
                          if (user.canViewStoragePaths)
  ...
  Widget _buildCorrespondentsView(LabelState state, User user) {
    return Builder(
      builder: (context) {
  ...
  Widget _buildDocumentTypesView(LabelState state, User user) {
    return Builder(
      builder: (context) {
        return CustomScrollView(
          slivers: [
  ...
  Widget _buildTagsView(LabelState state, User user) {
    return Builder(
      builder: (context) {
        return CustomScrollView(
          slivers: [
            ...
            LabelTabView<Tag>(
              ...
              leadingBuilder: (t) => CircleAvatar(
                ...
                child: t.isInboxTag
                    ? Icon(Icons.inbox, color: t.textColor)
                    : null,
              ),
  ...
  Widget _buildStoragePathView(LabelState state, User user) {
    return Builder(
      builder: (context) {
        return CustomScrollView(
          slivers: [
