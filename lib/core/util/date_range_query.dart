...
import 'package:paperless_mobile/core/util/converter/local_date_time_json_converter.dart';
  ...
  Map<String, String> toQueryParameter(DateRangeQueryField field) {
    ...
    if (after != null) {
      params.putIfAbsent(
          ...
          () => DateFormat('yyyy-MM-dd')
              .format(after!.subtract(const Duration(days: 1))));
    }
    ...
    if (before != null) {
      params.putIfAbsent(
          ...
          () => DateFormat('yyyy-MM-dd')
              .format(before!.add(const Duration(days: 1))));
    }
    return params;
  }
