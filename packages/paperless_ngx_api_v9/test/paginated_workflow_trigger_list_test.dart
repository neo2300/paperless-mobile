...
// tests for PaginatedWorkflowTriggerList
void main() {
  final PaginatedWorkflowTriggerList?
      instance = /* PaginatedWorkflowTriggerList(...) */ null;
  // TODO add properties to the entity

  group(PaginatedWorkflowTriggerList, () {
    // int count
