...
// tests for PatchedWorkflowTriggerRequest
void main() {
  final PatchedWorkflowTriggerRequest?
      instance = /* PatchedWorkflowTriggerRequest(...) */ null;
  // TODO add properties to the entity

  group(PatchedWorkflowTriggerRequest, () {
    // int id
