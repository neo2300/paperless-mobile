...
// tests for WorkflowActionWebhookRequest
void main() {
  final WorkflowActionWebhookRequest?
      instance = /* WorkflowActionWebhookRequest(...) */ null;
  // TODO add properties to the entity

  group(WorkflowActionWebhookRequest, () {
    // int id
    ...
    // bool useParams
    test('to test the property `useParams`', () async {
      // TODO
    });

    // bool asJson
    test('to test the property `asJson`', () async {
      // TODO
    });
    ...
    test('to test the property `includeDocument`', () async {
      // TODO
    });
  });
}
