...
part 'patched_document_type_request.g.dart';
...
class PatchedDocumentTypeRequest {
  /// Returns a new [PatchedDocumentTypeRequest] instance.
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is PatchedDocumentTypeRequest &&
  ...
  factory PatchedDocumentTypeRequest.fromJson(Map<String, dynamic> json) =>
      _$PatchedDocumentTypeRequestFromJson(json);
