...
class RemoteVersionApi {
  final Dio _dio;

  const RemoteVersionApi(this._dio);

  /// remoteVersionRetrieve
  ...
  Future<Response<Map<String, Object>>> remoteVersionRetrieve({
    ...
    final _path = r'/api/remote_version/';
