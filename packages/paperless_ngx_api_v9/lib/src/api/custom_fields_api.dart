...
class CustomFieldsApi {
  ...
  const CustomFieldsApi(this._dio);
  ...
  Future<Response<CustomField>> customFieldsCreate({
    ...
    final _path = r'/api/custom_fields/';
    ...
    try {
      _bodyData = jsonEncode(customFieldRequest);
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<CustomField, CustomField>(rawData, 'CustomField',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> customFieldsDestroy({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path =
        r'/api/custom_fields/{id}/'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PaginatedCustomFieldList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaginatedCustomFieldList>> customFieldsList({
    int? id,
    List<int>? idIn,
    ...
    PaginatedCustomFieldList? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<PaginatedCustomFieldList, PaginatedCustomFieldList>(
              rawData, 'PaginatedCustomFieldList',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
    ...
    return Response<PaginatedCustomFieldList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<CustomField>> customFieldsPartialUpdate({
    required int id,
    PatchedCustomFieldRequest? patchedCustomFieldRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(patchedCustomFieldRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [CustomField] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CustomField>> customFieldsRetrieve({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
