...
class ProfileApi {
  ...
  Future<Response<int>> profileDisconnectSocialAccountCreate({
    ProfileDisconnectSocialAccountCreateRequest?
        profileDisconnectSocialAccountCreateRequest,
    ...
    final _path = r'/api/profile/disconnect_social_account/';
    ...
    try {
      _bodyData = jsonEncode(profileDisconnectSocialAccountCreateRequest);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> profileGenerateAuthTokenCreate({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/profile/generate_auth_token/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Profile>> profilePartialUpdate({
    ...
    try {
      _bodyData = jsonEncode(patchedProfileRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [Profile] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Profile>> profileRetrieve({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, Object>>> profileSocialAccountProvidersRetrieve({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/profile/social_account_providers/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Map<String, Object>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, Object>>> profileTotpCreate({
    ProfileTotpCreateRequest? profileTotpCreateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/profile/totp/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      _bodyData = jsonEncode(profileTotpCreateRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<bool>> profileTotpDestroy({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [Map<String, Object>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Map<String, Object>>> profileTotpRetrieve({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
