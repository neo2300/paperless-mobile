...
class GroupsApi {
  ...
  Future<Response<Group>> groupsCreate({
    ...
    try {
      _bodyData = jsonEncode(groupRequest);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> groupsDestroy({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/groups/{id}/'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaginatedGroupList>> groupsList({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<PaginatedGroupList, PaginatedGroupList>(
              rawData, 'PaginatedGroupList',
              growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [Group] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Group>> groupsPartialUpdate({
    required int id,
    ...
    try {
      _bodyData = jsonEncode(patchedGroupRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [Group] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Group>> groupsRetrieve({
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Group] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Group>> groupsUpdate({
    required int id,
    required GroupRequest groupRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
