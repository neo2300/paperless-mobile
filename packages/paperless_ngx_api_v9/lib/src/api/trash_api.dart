...
class TrashApi {
  ...
  Future<Response<void>> trashCreate({
    required TrashRequest trashRequest,
    ...
    try {
      _bodyData = jsonEncode(trashRequest);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> trashList({
    int? page,
    int? pageSize,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
