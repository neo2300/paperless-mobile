# paperless_ngx_api_v9.api.RemoteVersionApi
...
------------- | ------------- | -------------
[**remoteVersionRetrieve**](RemoteVersionApi.md#remoteversionretrieve) | **GET** /api/remote_version/ | 


# **remoteVersionRetrieve**
> Map<String, Object> remoteVersionRetrieve()
...
final api = PaperlessNgxApiV9().getRemoteVersionApi();

try {
    final response = api.remoteVersionRetrieve();
    print(response);
} catch on DioException (e) {
    print('Exception when calling RemoteVersionApi->remoteVersionRetrieve: $e\n');
}
```
