# paperless_ngx_api_v9.api.StatusApi
...
final api = PaperlessNgxApiV9().getStatusApi();

try {
    final response = api.statusRetrieve();
    print(response);
} catch on DioException (e) {
    print('Exception when calling StatusApi->statusRetrieve: $e\n');
}
```
