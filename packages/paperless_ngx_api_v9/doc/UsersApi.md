# paperless_ngx_api_v9.api.UsersApi
...
------------- | ------------- | -------------
[**usersCreate**](UsersApi.md#userscreate) | **POST** /api/users/ | 
[**usersDeactivateTotpCreate**](UsersApi.md#usersdeactivatetotpcreate) | **POST** /api/users/{id}/deactivate_totp/ | 
[**usersDestroy**](UsersApi.md#usersdestroy) | **DELETE** /api/users/{id}/ | 
...
final api = PaperlessNgxApiV9().getUsersApi();
final UserRequest userRequest = ; // UserRequest | 

try {
    final response = api.usersCreate(userRequest);
    print(response);
...
> bool usersDeactivateTotpCreate(id)
...
try {
    final response = api.usersDeactivateTotpCreate(id);
    print(response);
} catch on DioException (e) {
    print('Exception when calling UsersApi->usersDeactivateTotpCreate: $e\n');
}
```
...
try {
    ...
    print('Exception when calling UsersApi->usersDestroy: $e\n');
}
```
...
# **usersList**
> PaginatedUserList usersList(ordering, page, pageSize, usernameIcontains, usernameIendswith, usernameIexact, usernameIstartswith)
...
final String usernameIcontains = usernameIcontains_example; // String | 
final String usernameIendswith = usernameIendswith_example; // String | 
final String usernameIexact = usernameIexact_example; // String | 
final String usernameIstartswith = usernameIstartswith_example; // String | 

try {
    final response = api.usersList(ordering, page, pageSize, usernameIcontains, usernameIendswith, usernameIexact, usernameIstartswith);
    print(response);
} catch on DioException (e) {
 ...
 **usernameIcontains** | **String**|  | [optional] 
 **usernameIendswith** | **String**|  | [optional] 
 **usernameIexact** | **String**|  | [optional] 
 **usernameIstartswith** | **String**|  | [optional] 
...
try {
    final response = api.usersPartialUpdate(id, patchedUserRequest);
    print(response);
} catch on DioException (e) {
...
try {
    final response = api.usersUpdate(id, userRequest);
    print(response);
} catch on DioException (e) {
