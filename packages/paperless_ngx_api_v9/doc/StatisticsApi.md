# paperless_ngx_api_v9.api.StatisticsApi
...
------------- | ------------- | -------------
[**statisticsRetrieve**](StatisticsApi.md#statisticsretrieve) | **GET** /api/statistics/ | 


# **statisticsRetrieve**
> Map<String, Object> statisticsRetrieve()
...
final api = PaperlessNgxApiV9().getStatisticsApi();

try {
    final response = api.statisticsRetrieve();
    print(response);
} catch on DioException (e) {
    print('Exception when calling StatisticsApi->statisticsRetrieve: $e\n');
}
```
