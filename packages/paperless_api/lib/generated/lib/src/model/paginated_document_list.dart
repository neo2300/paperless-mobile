...
part 'paginated_document_list.g.dart';
...
class PaginatedDocumentList {
  /// Returns a new [PaginatedDocumentList] instance.
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is PaginatedDocumentList &&
  ...
  factory PaginatedDocumentList.fromJson(Map<String, dynamic> json) =>
      _$PaginatedDocumentListFromJson(json);

  Map<String, dynamic> toJson() => _$PaginatedDocumentListToJson(this);
