...
part 'paginated_tag_list.g.dart';
...
class PaginatedTagList {
  /// Returns a new [PaginatedTagList] instance.
  PaginatedTagList({
    required this.count,
  ...
  factory PaginatedTagList.fromJson(Map<String, dynamic> json) =>
      _$PaginatedTagListFromJson(json);

  Map<String, dynamic> toJson() => _$PaginatedTagListToJson(this);
